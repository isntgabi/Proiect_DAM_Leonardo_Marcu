...
public class Venituri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dashboard.setOnClickListener(view -> {
            redirectActivity(Venituri.this, Dashboard.class);
        });

        profile.setOnClickListener(view -> {
            redirectActivity(Venituri.this, Profile.class);
        });
        budget.setOnClickListener(view -> {
            redirectActivity(Venituri.this, Buget.class);
        });
        venituri.setOnClickListener(view -> {
            recreate();
        });
        cheltuieli.setOnClickListener(view -> {
            redirectActivity(Venituri.this, Cheltuieli.class);
        });
        hystoric.setOnClickListener(view -> {
            redirectActivity(Venituri.this, Istoric.class);
        });
        graph.setOnClickListener(view -> {
            redirectActivity(Venituri.this, Grafic.class);
        });
        ...
        EditText etSuma = findViewById(R.id.etSumaBuget);
