...
public class Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        budget.setOnClickListener(view -> {
            redirectActivity(Profile.this,Buget.class);
        });
        venituri.setOnClickListener(view -> {
            redirectActivity(Profile.this,Venituri.class);
        });
        cheltuieli.setOnClickListener(view -> {
            redirectActivity(Profile.this,Cheltuieli.class);
        });
        hystoric.setOnClickListener(view -> {
            redirectActivity(Profile.this,Istoric.class);
        });
        graph.setOnClickListener(view -> {
            redirectActivity(Profile.this,Grafic.class);
        });
